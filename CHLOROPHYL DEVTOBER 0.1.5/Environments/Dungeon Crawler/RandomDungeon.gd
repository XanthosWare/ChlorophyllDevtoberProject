...
var Room = preload("res://Environments/Dungeon Crawler/Room.tscn")
var Enemy = preload("res://Enemy/Enemy.tscn")

onready var teleporter = $"Teleporter Area2D"
...
func place_player():
	...
	Global.load_companions("/root/Random Dungeon")
...
func place_exit():
	teleporter.position = end_room.position
...
func _on_Teleporter_Area2D_body_entered(body):
